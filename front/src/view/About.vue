...
<section>
    <div class="title mt-2">
        <h3>About</h3>
        <p>About our team for this project</p>
    </div>
    <div class="card col-8 m-auto">
        ...
        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ullam vitae soluta odio placeat, facere error recusandae, aperiam ea veniam fuga quisquam aut nostrum voluptatem ipsum maiores, ipsa at quo officia.
        </p>
    </div>
</section>
</template>
